    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-60 flex items-center justify-center">
            <div className="relative max-w-4xl w-full mx-4 shadow-lg bg-gray-900 rounded-xl overflow-hidden">
                <div className="flex justify-end items-center gap-2 p-4 bg-white dark:bg-gray-800">
                    <button
                    ...
                    <button className="text-white dark:text-black bg-gray-700 dark:bg-gray-100 rounded-full p-2 hover:bg-gray-500 dark:hover:bg-gray-500" onClick={onClose}>
                        <X className="w-5 h-5" />
                    </button>
                </div>
